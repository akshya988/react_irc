  ...
  return (
    <div className="footer-section">
        ...
        <div className="ft-info">
          <div className="ft-info-p1">
            <p className="ft-title">
              GoGlam <span className="ft-sign"></span>
            </p>
            <p className="ft-description">
            Get brighter, radiant skin! The GoGlam is a skin rejuvenation webpage that reduces discolouration and evens out your skin tone for long lasting, glowing skin.
            </p>
          </div>
      ...
      <div className="ft-copyright">
        <p>© 2013-2023 GoGlam. All rights reserved.</p>
